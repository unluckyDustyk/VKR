namespace Mapbox.Examples
{
	...
	public class CameraMovement : MonoBehaviour
	{
        ...
        [SerializeField] private RectTransform mapRenderArea;
        ...
        bool IsPointerOverMap()
        {
            return RectTransformUtility.RectangleContainsScreenPoint(mapRenderArea, Input.mousePosition, null);
        }
    }
}